      ...
      <div className={s.homePageContent}>
          ...
          <section>
            <div className={s.content}>
              <div className="container">
                ...
                <h3 className={s.h3Header}>ДЛЯ РАБОТЫ В ВЕДУЩИХ КОМПАНИЯХ РОССИИ</h3>
                <br/>
                <p>Мы помогаем IT компаниям растить правильные компетенции у кандидатов</p>

                <Button text="Хочу стать разработчиком" primary></Button>
        ...
        <Container className={s.paddingContainer}>
          <Row>
            <div className="col-sm-3">
              <div>
                <img
                  className={s.commandPhoto}
                  src={rumyantsev}
                />
                <h4 className="text-center">ДМИТРИЙ<br/>РУМЯНЦЕВ</h4>
                <p className="section-heading text-primary text-center">ОПЕРАЦИОННЫЙ ДИРЕКТОР</p>
                <p className={s.commandDesctiption}>Закончил Ленинградский Государственный Университет по специальности
            ...
            <div className="col-sm-3">
              <div>
                <img
                  ...
                  alt=""
                />
                <h4 className="text-center">ВЛАД<br/>ЯКОВЛЕВ</h4>
                <p className="section-heading text-primary text-center">АКАДЕМИЧЕСКИЙ ДИРЕКТОР</p>
                <p className={s.commandDesctiption}>В 1999 г. закончил Финансовый институт (г. Ташкент) по специальности
            ...
            <div className="col-sm-3">
              <div>
                <img
                  ...
                  src={matorin}
                />
                <h4 className="text-center">АЛЕКСАНДР<br/>МАТОРИН</h4>
                <p className="section-heading text-primary text-center">ПРЕПОДАВАТЕЛЬ</p>
                <p className={s.commandDesctiption}>Закончил Саратовский государственный университет им. Н.Г.
                  Чернышевского,
            ...
            <div className="col-sm-3">
              <div>
                <img
                  ...
                  src={zubov}
                />
                <h4 className="text-center">СЕРГЕЙ<br/>ЗУБОВ</h4>
                <p className="section-heading text-primary text-center">ПРЕПОДАВАТЕЛЬ</p>
          ...
          <Row>
            <h5 className={s.work}>Хочешь у нас преподавать? Пройди по этой <a
              href="/signup-teacher"
            >ссылке.</a>
              &nbsp; Мы с тобой свяжемся.</h5>
          ...
          <Container fluid>
            <Row>
              ...
              <div className={`col-sm-8 ${s.missionText}`}>
                ...
                <p className={s.textParagraph}>Получи знания, заяви о себе, найди себя, открой мечту. Стань
                  разработчиком, найди работу в ведущих IT компаниях.</p>
                <Row className={s.missionDescription}>
                    ...
                    <div className="media">
                      <div className="media-body">
                        <ul className={s.missionUl}>
                          <li className={s.textParagraph}>Мы даем только необходимые знания</li>
                          <li className={s.textParagraph}>Мы сокращаем дистанцию между тобой и профессией</li>
                        </ul>
                      </div>
                  ...
                  <div className="col-sm-6">
                    ...
                    <div className="media">
                      <div className="media-body">
                        <ul className={s.missionUl}>
                          <li className={s.textParagraph}>Подготовим тебя под требования компании</li>
                          <li className={s.textParagraph}>Обеспечим интервью в компании</li>
                          <li className={s.textParagraph}>Выдадим цифровой сертификат</li>
                        </ul>
                      </div>
        ...
        <Container className={s.paddingContainer}>
          <Row className={s.headerMargin}>
            <h1 className={s.blockCenter}><span className={s.textBlue}>ЧТО</span> МЫ ДЕЛАЕМ</h1>
          </Row>
          <Row>
            <div className={`${s.helpBlock} col-sm-7`}>
              <Row className={s.textGrey}>
                ...
                <div className={`col-sm-12  text-center ${s.bulbPadding} ${s.textDark}`}>
                  <h2 >ПОМОГАЕМ НА ВСЕМ ПУТИ</h2>
                </div>
                <div className="col-sm-12  text-center">
                  <p>Интерактивное общение с преподавателями

                    Выполнение проектов, построенных на реальных кейсах

                    Профессиональная подготовка резюме

                    Имитация собеседования в компании</p>
                </div>
                <div className={`col-sm-12  text-center ${s.bulbPadding} ${s.textDark}`}>
        ...
        <Container style={{
          ...
          <Row className={s.headerPadding}>
            <h1 className={s.blockCenter}>НАШИ ПАРТНЕРЫ В СТАДИИ ПЕРЕГОВОРОВ</h1>
            <hr/>
          </Row>
          ...
          <div>
            <Button text="Стать партнером" primary></Button>
          </div>
        </Container>
        <div className={s.darkSection}>
          <Container>
          ...
          <Container >
            <Row className={s.priceRow}>
              <div className={`col-sm-6 text-center`}>
                ...
                <div className={s.priceCount} ><h1 className={s.marginPriceCount}><b>6500</b></h1> <p>в месяц</p></div>
                <div className={s.priceBlock}>
                  <p><b>15</b> спринтов курса java</p>
                  <p><b>1</b> резюме. поможем составить его правильно</p>
                  <p><b>3</b> собеседования в разные компании</p>
                  <div>
                    <Button text="Зарегистрироваться" primary></Button>
                  </div>
                </div>
              </div>
              <div className={`col-sm-6 text-center`}>
            ...
            <Row>
              <div className={`col-sm-4 ${s.headerMargin}`}>
                <img
                  ...
                  alt=""
                />
                <h1>Наташа Брезнякова
                </h1>
                <p> МФТИ / Сбертех</p>
                <p> „EdHunter дал мне необходимые
                  знания для моей карьеры!“</p>
              </div>
              <div className={`col-sm-4 ${s.headerMargin}`}>
                <img
                  src={icon2}
        ...
        <Container>
          ...
          <Row className="text-center">
            <p> Партнерская программа - это возможность в кратчайшие сроки найти и прособеседовать лучших
              молодых специалистов с необходимыми вашей компании компетенциями.
              Мы также готовы создать учебный курс по вашему заказу и предлагаем вам воспользоваться
              опцией “Таргетированный отбор”.</p>
            <div className={s.blockCenter}>
              <Button text="Для компаний" primary></Button>
            </div>
          </Row>
        </Container>
        <div className={s.contactBlock}>
          <Container>
            <Row className={s.headerPadding}>
              ...
              <p className={s.blockCenter}>Предложите курс, или просто оставьте контакты, мы с Вами свяжемся.</p>
            </Row>
            <Row>
